...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_5.addWidget(self.label, 0, QtCore.Qt.AlignHCenter)
        self.input_raster_layer = QtWidgets.QComboBox(self.centralwidget)
        self.input_raster_layer.setObjectName("input_raster_layer")
        self.horizontalLayout_5.addWidget(self.input_raster_layer)
        ...
        self.horizontalLayout_10.addWidget(self.label_2, 0, QtCore.Qt.AlignHCenter)
        self.input_vector_layer = QtWidgets.QComboBox(self.centralwidget)
        self.input_vector_layer.setObjectName("input_vector_layer")
        self.horizontalLayout_10.addWidget(self.input_vector_layer)
        ...
        self.gridLayout.addWidget(self.label_41, 3, 0, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setObjectName("label_11")
        self.gridLayout.addWidget(self.label_11, 3, 1, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.horizontalLayout_9.setContentsMargins(6, 5, 6, 5)
